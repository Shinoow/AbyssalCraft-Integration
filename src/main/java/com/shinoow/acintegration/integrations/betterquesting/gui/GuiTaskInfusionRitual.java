...
//			screen.mc.fontRendererObj.drawString("Infuse the following through a Infusion Ritual:", posX + sizeX/2 - screen.mc.fontRendererObj.getStringWidth("Infuse the following through a Infusion Ritual:")/2 + 20, posY + sizeY/2 - 65, ThemeRegistry.curTheme().textColor().getRGB());
