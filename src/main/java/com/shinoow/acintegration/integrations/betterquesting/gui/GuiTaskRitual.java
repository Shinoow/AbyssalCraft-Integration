...
public class GuiTaskRitual extends GuiEmbedded {
	...
	public void drawGui(int mx, int my, float partialTick) {
		...
		screen.mc.fontRendererObj.drawString(StatCollector.translateToLocal("ac.ritual." + task.name), posX + sizeX/2 - screen.mc.fontRendererObj.getStringWidth(StatCollector.translateToLocal("ac.ritual." + task.name))/2 - 10, (posY + sizeY/2 - 17) + 10, ThemeRegistry.curTheme().textColor().getRGB());
	}
}