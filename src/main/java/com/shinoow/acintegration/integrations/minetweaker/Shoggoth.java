...
public class Shoggoth {
	...
	private static class AddBlacklist implements IUndoableAction {
		...
		public String describe() {
			...
			return "Added Block " + StatCollector.translateToLocal(block.getUnlocalizedName() + ".name") + " to the Lesser Shoggoth Block Blacklist";
		}

		@Override
		public String describeUndo() {

			return "Removed Block " + StatCollector.translateToLocal(block.getUnlocalizedName() + ".name") + " from the Lesser Shoggoth Block Blacklist";
		}
