...
public class SummonRitual {
	...
	private static class Add implements IUndoableAction
	{
		...
		public String describeUndo() {
			...
			return "Removing Necronomicon Summoning Ritual for " + (EntityList.getKey(ritual.getEntity()) != null ? EntityList.getKey(ritual.getEntity()) : "");
		}
	...
	private static class Remove implements IUndoableAction
	{
		...
		public String describeUndo() {
			...
			return "Re-adding Necronomicon Summoning Ritual for "+ (EntityList.getKey(entity) != null ? EntityList.getKey(entity).toString() : "");
		}
