...
public class DreadlandsRodOnUpdate implements IWandRodOnUpdate {
	...
	public void onUpdate(ItemStack itemstack, EntityPlayer player) {
		if(player.ticksExisted % 100 == 0)
			if(player.worldObj.getBiomeGenForCoords(player.getPosition()) == AbyssalCraft.Dreadlands ||
			player.worldObj.getBiomeGenForCoords(player.getPosition()) == AbyssalCraft.ForestDreadlands ||
			player.worldObj.getBiomeGenForCoords(player.getPosition()) == AbyssalCraft.MountainDreadlands)
