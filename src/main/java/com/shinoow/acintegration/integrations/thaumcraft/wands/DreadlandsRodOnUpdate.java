...
//			if(player.worldObj.getBiomeGenForCoords(player.getPosition()) instanceof IDreadlandsBiome &&
//					player.worldObj.getBiomeGenForCoords(player.getPosition()) != ACBiomes.purified_dreadlands)
