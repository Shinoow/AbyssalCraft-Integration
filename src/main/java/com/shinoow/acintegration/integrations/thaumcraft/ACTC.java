...
public class ACTC implements IACPlugin {
	...
	public void init(){
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.dreadportal), new AspectList().add(Aspect.DARKNESS, 4).add(ACTCMisc.DREAD, 1).add(Aspect.TRAVEL, 4));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.Corflesh), new AspectList().add(Aspect.FLESH, 2).add(Aspect.MAN, 1).add(ACTCMisc.CORALIUM, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.Corbone), new AspectList().add(Aspect.FLESH, 2).add(Aspect.MAN, 1).add(ACTCMisc.CORALIUM, 1).add(Aspect.DEATH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.dreadfragment), new AspectList().add(Aspect.FLESH, 2).add(Aspect.MAN, 1).add(ACTCMisc.DREAD, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.PSDLfinder), new AspectList().add(Aspect.MAGIC, 2).add(Aspect.SENSES, 2).add(ACTCMisc.CORALIUM, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.essence, 1, 0), new AspectList().add(Aspect.MAGIC, 2).add(ACTCMisc.CORALIUM, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.essence, 1, 1), new AspectList().add(Aspect.MAGIC, 2).add(ACTCMisc.DREAD, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.skin, 1, 0), new AspectList().add(Aspect.FLESH, 3).add(Aspect.MAN, 2).add(ACTCMisc.CORALIUM, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.skin, 1, 1), new AspectList().add(Aspect.FLESH, 3).add(Aspect.MAN, 2).add(ACTCMisc.DREAD, 2));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.shoggothFlesh, 1, 1), new AspectList().add(Aspect.UNDEAD, 3).add(Aspect.FLESH, 3).add(Aspect.SLIME, 3).add(ACTCMisc.CORALIUM, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(AbyssalCraft.shoggothFlesh, 1, 2), new AspectList().add(Aspect.UNDEAD, 3).add(Aspect.FLESH, 3).add(Aspect.SLIME, 3).add(ACTCMisc.DREAD, 3));
		...
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.dreadguard), new AspectList().add(Aspect.UNDEAD, 5).add(Aspect.FLESH, 5).add(ACTCMisc.DREAD, 5));
		...
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.dreadling), new AspectList().add(Aspect.UNDEAD, 3).add(ACTCMisc.DREAD, 3).add(Aspect.FLESH, 3));
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.dread_spawn), new AspectList().add(Aspect.UNDEAD, 3).add(ACTCMisc.DREAD, 3).add(Aspect.FLESH, 3));
		...
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.spawn_of_chagaroth), new AspectList().add(Aspect.UNDEAD, 3).add(Aspect.FLESH, 3).add(ACTCMisc.DREAD, 3));
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.fist_of_chagaroth), new AspectList().add(Aspect.UNDEAD, 3).add(Aspect.FLESH, 3).add(ACTCMisc.DREAD, 3));
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.chagaroth), new AspectList().add(Aspect.UNDEAD, 8).add(Aspect.FLESH, 10).add(ACTCMisc.DREAD, 15));
		...
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.greater_dread_spawn), new AspectList().add(Aspect.UNDEAD, 3).add(ACTCMisc.DREAD, 3).add(Aspect.FLESH, 3));
		ThaumcraftApi.registerEntityTag(getMobName(ACEntities.lesser_dreadbeast), new AspectList().add(Aspect.UNDEAD, 3).add(ACTCMisc.DREAD, 3).add(Aspect.FLESH, 3));
		...
		ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", AbyssalCraft.coraliumE, 20, new AspectList().add(ACTCMisc.CORALIUM, 10).add(Aspect.ENERGY, 10), new ItemStack[]{new ItemStack(AbyssalCraft.Cingot), new ItemStack(AbyssalCraft.Corflesh)});
		ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", AbyssalCraft.dreadE, 20, new AspectList().add(ACTCMisc.DREAD, 10).add(Aspect.ENERGY, 10), new ItemStack[]{new ItemStack(AbyssalCraft.dreadiumingot), new ItemStack(AbyssalCraft.dreadfragment)});
	}
