...
public class ACTC implements IACPlugin {
	...
	public void init(){
		...
		//Aspects, blocks
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.darkstone), new AspectList().add(Aspect.EARTH, 2).add(Aspect.DARKNESS, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.darkstone_cobblestone), new AspectList().add(Aspect.EARTH, 1).add(Aspect.ENTROPY, 1).add(Aspect.DARKNESS, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.abyssal_stone), new AspectList().add(Aspect.EARTH, 2).add(ACTCMisc.CORALIUM, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.dreadstone), new AspectList().add(Aspect.EARTH, 2).add(ACTCMisc.DREAD, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.abyssalnite_stone), new AspectList().add(Aspect.EARTH, 2));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.ethaxium), new AspectList().add(Aspect.SOUL, 2).add(Aspect.ELDRITCH, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.omothol_stone), new AspectList().add(Aspect.EARTH, 2).add(Aspect.ELDRITCH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.coralium_stone), new AspectList().add(Aspect.EARTH, 2).add(ACTCMisc.CORALIUM, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.monolith_stone), new AspectList().add(Aspect.EARTH, 2).add(Aspect.ELDRITCH, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.cthulhu_statue), new AspectList().add(Aspect.ENERGY, 2).add(Aspect.MAN, 1).add(Aspect.ELDRITCH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.hastur_statue), new AspectList().add(Aspect.ENERGY, 2).add(Aspect.MAN, 1).add(Aspect.ELDRITCH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.jzahar_statue), new AspectList().add(Aspect.ENERGY, 2).add(Aspect.MAN, 1).add(Aspect.ELDRITCH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.azathoth_statue), new AspectList().add(Aspect.ENERGY, 2).add(Aspect.MAN, 1).add(Aspect.ELDRITCH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.nyarlathotep_statue), new AspectList().add(Aspect.ENERGY, 2).add(Aspect.MAN, 1).add(Aspect.ELDRITCH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.yog_sothoth_statue), new AspectList().add(Aspect.ENERGY, 2).add(Aspect.MAN, 1).add(Aspect.ELDRITCH, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.shub_niggurath_statue), new AspectList().add(Aspect.ENERGY, 2).add(Aspect.MAN, 1).add(Aspect.ELDRITCH, 1));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 16), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 17), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 18), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 19), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 20), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 21), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 22), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 23), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(ACBlocks.crystal_cluster, 1, 24), new AspectList().add(Aspect.CRYSTAL, 3).add(Aspect.METAL, 1));
